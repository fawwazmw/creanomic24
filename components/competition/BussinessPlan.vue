<template>
  <section
      class="bussinessplan-section relative bg-white flex flex-col items-center justify-start md:px-0 overflow-hidden"
  >

    <!-- New Image Below Header with Positioning Using Top-[50vh] -->
    <div class="w-full absolute flex justify-center top-[35vh] bussinessplan">
      <img
          src="assets/bussinessplanhead.svg"
          alt="Header Image"
    ...
    <div class="absolute flex justify-center items-center w-full top-[140vh] mainimage">
      ...
      <!-- Third Image (270x76) -->
      <img
          src="assets/twoteam.svg"
          alt="Third Image"
          class="w-[270px] h-[76px] object-cover mx-2 twoteam"
      />
    ...
    <a href="https://drive.google.com/drive/folders/1bEyYuVeqzjUS9v7FwpajjVTJAXzjLMCN" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[20vw] z-10 guidebook">
      <img
    ...
    <a href="https://wa.me/6282234713979?text=Hello%20Saya%20tertarik%20dengan%20mengikuti%20Lomba%20Bussiness Plan ini!" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[40vw] z-10 cp_image">
      <img
          src="assets/cp.svg"
          alt="CP"
          class="object-cover w-full h-auto"
...
export default {
  ...
  data() {
    return {
      textWords:
          `Lomba business plan adalah kompetisi di mana peserta merancang rencana bisnis inovatif. Peserta menyusun analisis pasar dan strategi pemasaran, yang dinilai oleh juri ahli. Tujuan dari lomba ini untuk mendorong kreativitas dan inovasi.`.split(
              " "
          ),
    };
  },
  mounted() {
    // Animasi untuk bussinessplan dari bawah ke atas
    gsap.from(".bussinessplan", {
