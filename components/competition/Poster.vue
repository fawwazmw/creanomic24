<template>
  <section
      class="poster-section relative bg-white flex flex-col items-center justify-start md:px-0 overflow-hidden"
  >

    <!-- New Image Below Header with Positioning Using Top-[50vh] -->
    <div class="w-full absolute flex justify-center top-[35vh] poster">
      <img
          src="assets/posterhead.svg"
          alt="Header Image"
    ...
    <a href="https://drive.google.com/drive/folders/1nui0hderRk9uwGxOKtvcJ4vWv4Pe6gGm" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[20vw] z-10 guidebook">
      <img
    ...
    <a href="https://wa.me/6281218102977?text=Hello%20Saya%20tertarik%20dengan%20mengikuti%20Lomba%20Poster ini!" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[40vw] z-10 cp_image">
      <img
          src="assets/cp.svg"
          alt="CP"
          class="object-cover w-full h-auto"
...
export default {
  ...
  data() {
    return {
      textWords:
          `Lomba poster adalah kompetisi menghasilkan karya-karya informatif yang unik, kreatif serta inovatif, dengan tujuan mewujudkan transformasi di bidang kewirausahaan. Lomba ini dapat  dapat meningkatkan minat dan motivasi dalam berkarya serta memberi informasi kepada khalayak.`.split(
              " "
          ),
    };
  },
  mounted() {
    // Animasi untuk poster dari bawah ke atas
    gsap.from(".poster", {
