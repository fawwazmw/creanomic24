<template>
  <section
      class="comicquest-section relative bg-white flex flex-col items-center justify-start md:px-0 overflow-hidden"
  >

    <!-- New Image Below Header with Positioning Using Top-[50vh] -->
    <div class="w-full absolute flex justify-center top-[35vh] comicquest">
      <img
          src="assets/comicquesthead.svg"
          alt="Header Image"
    ...
    <div class="absolute flex justify-center items-center w-full top-[140vh] mainimage">
      ...
      <img
          ...
          alt="Third Image"
          class="w-[270px] h-[76px] object-cover mx-2 individu"
      />
    ...
    <a href="https://drive.google.com/drive/folders/1_EGRsje2xqhDVm3tYc3xswdeh_fUY8EV" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[20vw] z-10 guidebook">
      <img
    ...
    <a href="https://wa.me/6282372278912?text=Hello%20Saya%20tertarik%20dengan%20mengikuti%20Lomba%20Comic Quest ini!" class="hoverable-icon absolute w-[170px] h-auto top-[260vh] left-[40vw] z-10 cp_image">
      <img
          src="assets/cp.svg"
          alt="CP"
          class="object-cover w-full h-auto"
...
export default {
  ...
  data() {
    return {
      textWords:
          `ComicQuest adalah sebuah kompetisi di mana peserta membuat cerita visual berupa komik yang dinilai berdasarkan kualitas cerita, gambar, kreativitas, dan kesesuaian dengan tema yang ditentukan. Tujuan dari lomba ini adalah untuk mendorong imajinasi, kreativitas, serta mengedukasi melalui seni bercerita dengan gambar.`.split(
              " "
          ),
    };
  },
  mounted() {
    // Animasi untuk comicquest dari bawah ke atas
    gsap.from(".comicquest", {
