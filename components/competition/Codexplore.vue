<template>
  <section
      class="codexplore-section relative bg-white flex flex-col items-center justify-start md:px-0 overflow-hidden"
  >

    <!-- New Image Below Header with Positioning Using Top-[50vh] -->
    <div class="w-full absolute flex justify-center top-[35vh] codexplore">
      <img
          src="assets/codexplorehead.svg"
          alt="Header Image"
    ...
    <div class="absolute flex justify-center items-center w-full top-[140vh] mainimage">
      ...
      <!-- Third Image (270x76) -->
      <img
          src="assets/threeteam.svg"
          alt="Third Image"
          class="w-[270px] h-[76px] object-cover mx-2 threeteam"
      />
...
export default {
  ...
  data() {
    return {
      textWords:
          `CodeXPlore adalah kompetisi untuk merancang dan mengembangkan aplikasi web yang fungsional, lengkap dengan frontend dan backend. Tujuan dari lomba ini adalah untuk mendorong inovasi, kreativitas, dan keterampilan teknis peserta dalam merancang aplikasi yang dapat melahirkan ide-ide cemerlang yang dapat diimplementasikan dalam dunia bisnis.`.split(
              " "
          ),
    };
  },
  mounted() {
    // Animasi untuk codexplore dari bawah ke atas
    gsap.from(".codexplore", {
