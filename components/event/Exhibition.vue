<template>
  <section
      class="exhibition-section relative bg-white h-auto md:h-[3236px] flex flex-col items-center justify-start md:px-0 overflow-hidden"
  >

    <!-- New Image Below Header -->
    <div class="w-full flex justify-center mt-[28vh] exhibitionhead">
      <img
          src="assets/exhibitionhead.svg"
          alt="Header Image"
...
export default {
  ...
  mounted() {
    // Animasi untuk exhibitionhead dari bawah ke atas
    gsap.from(".exhibitionhead", {
